...
function UsernameSetupModal({ userId, onComplete }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            setLoading(true);
            setError('');
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$anonymous$2d$social$2d$platform$2f$app$2f$actions$2f$data$3a$a7b646__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createUsername"])({
                userId,
...
//# sourceMappingURL=Downloads_anonymous-social-platform_626a887e._.js.map